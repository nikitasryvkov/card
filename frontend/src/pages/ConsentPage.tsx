...
const sections = [
  {
    ...
    paragraphs: [
      ...
      `Согласие действует в отношении данных, которые пользователь передает через сайт ${businessInfo.websiteUrl}, электронную почту, телефон, Telegram и иные согласованные каналы связи.`,
    ],
  },
  {
  ...
  },
  {
    ...
    paragraphs: [
      "Обратная связь по обращению, подготовка коммерческих предложений, договоров, счетов и актов, заключение и исполнение договора, ведение деловой переписки и защита сайта от злоупотреблений.",
    ],
  },
  {
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "В текущей публичной версии сайта не используются рекламные, маркетинговые и аналитические cookie либо пиксели внешних рекламных систем.",
    ],
  },
  {
      ...
      <main className="mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="rounded-[36px] border border-white/10 bg-white/5 p-6 shadow-panel backdrop-blur sm:p-8">
          ...
          <p className="mt-4 break-words text-base leading-8 text-mist/75">
            ...
            данных при переписке по проекту, обращении через email, телефон, Telegram и ином взаимодействии
            с {businessInfo.shortName}. Веб-форма на текущей версии сайта не используется.
          </p>
        </div>
