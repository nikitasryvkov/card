...
const sections = [
  {
    ...
    paragraphs: [
      ...
      `Согласие действует в отношении данных, которые пользователь передает через сайт ${businessInfo.websiteUrl}, электронную почту, форму регистрации, форму заявки и иные согласованные каналы связи.`,
    ],
  },
  {
  ...
  },
  {
    ...
    paragraphs: [
      "Обратная связь по заявке, регистрация и сопровождение личного кабинета, подготовка коммерческих предложений, договоров, счетов и актов, заключение и исполнение договора, ведение деловой переписки и защита сайта от злоупотреблений.",
    ],
  },
  {
      ...
      <main className="mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="rounded-[36px] border border-white/10 bg-white/5 p-6 shadow-panel backdrop-blur sm:p-8">
          ...
          <p className="mt-4 break-words text-base leading-8 text-mist/75">
            ...
            данных при заполнении формы заявки, регистрации в личном кабинете, переписке по проекту и ином
