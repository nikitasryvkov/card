...
const sections = [
  ...
  },
  {
    ...
    body: "Имя и фамилия, наименование компании, номер телефона, адрес электронной почты, содержание обращения, сведения для подготовки договоров и счетов, учетные данные личного кабинета, а также технические данные браузера, IP-адрес, служебные cookie и токены безопасности.",
  },
  {
    title: "4. Цели обработки",
    body: "Обработка входящих заявок, обратная связь с пользователем, регистрация и сопровождение личного кабинета, подготовка коммерческих предложений, договоров, счетов и актов, исполнение обязательств по договору, обеспечение безопасности сайта и улучшение качества услуг.",
  },
  {
  ...
  },
  {
    ...
    body: "Оператор принимает разумные организационные и технические меры для защиты персональных данных от неправомерного доступа, изменения, раскрытия или уничтожения. Для обеспечения безопасности авторизации и защищенного взаимодействия на сайте используются технические cookie и токены сессии.",
  },
  {
    title: "11. Контакты",
      ...
      <main className="mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="rounded-[36px] border border-white/10 bg-white/5 p-6 shadow-panel backdrop-blur sm:p-8">
          ...
          <p className="mt-4 break-words text-base leading-8 text-mist/75">
            ...
            электронную почту, личный кабинет и иные каналы связи при запросе услуг, консультации или
            дальнейшем взаимодействии с {businessInfo.shortName}.
          </p>
        </div>
