...
const sections = [
  ...
  },
  {
    ...
    body: "Обратная связь с пользователем по телефону, email, Telegram и иным согласованным каналам, подготовка коммерческих предложений, договоров, счетов и актов, исполнение обязательств по договору, обеспечение безопасности сайта и улучшение качества услуг.",
  },
  {
      ...
      <main className="mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="rounded-[36px] border border-white/10 bg-white/5 p-6 shadow-panel backdrop-blur sm:p-8">
          ...
          <p className="mt-4 break-words text-base leading-8 text-mist/75">
            Настоящая политика действует в отношении данных, которые пользователь передает через email,
            телефон, Telegram и иные каналы связи при запросе услуг, консультации или дальнейшем
            взаимодействии с {businessInfo.shortName}. Веб-форма на текущей версии сайта не используется.
          </p>
        </div>
