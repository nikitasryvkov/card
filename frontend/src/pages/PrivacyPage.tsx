      ...
      <main className="mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="rounded-[36px] border border-black/5 bg-white/80 p-8 shadow-panel">
          ...
          <p className="mt-4 text-base leading-8 text-steel">
            Ниже приведен базовый текст политики конфиденциальности для сайта услуг и формы обратной связи. Перед окончательной публикацией его желательно сверить с фактическими бизнес-процессами.
          </p>
        </div>
